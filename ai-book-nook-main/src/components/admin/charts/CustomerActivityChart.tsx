...
const CustomerActivityChart = ({ refreshTrigger }: { refreshTrigger?: number }) => {
    ...
    return (
        <div className="bg-card p-6 rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow">
            <h3 className="font-serif text-lg font-bold text-foreground mb-1">Customer Growth</h3>
            <p className="text-xs text-muted-foreground mb-6">New user registrations per day</p>
            ...
            <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                        ...
                        <Bar dataKey="newUsers" fill="#ec4899" radius={[4, 4, 0, 0]} name="New Users" barSize={30} />
                    </BarChart>
                </ResponsiveContainer>
            </div>
        </div>
